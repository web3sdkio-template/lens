// Learn how we use the web3sdkio SDK to connect to the Lens smart contract using it's ABI:
// https://blog.web3sdk.io/guides/how-to-use-any-smart-contract-with-web3sdkio-sdk-using-abi/
